...
public class AccountCacheTest {
    ...
    public void testCacheLoadsPrototypes() {
        AbstractAccount savingPrototype = AccountCache.getAccount(AccountCache.SAVING);
        AbstractAccount checkingPrototype = AccountCache.getAccount(AccountCache.CHECKING);
    ...
    public void testCachePrototypesHaveDefaultValues() {
        ...
        assertEquals(0.0, checkingPrototype.getBalance(), 0.0);
    ...
    public void testCloneSavingAccountReturnsNewInstance() {
        AbstractAccount cloned = AccountCache.cloneAccount(AccountCache.SAVING);
        AbstractAccount prototype = AccountCache.getAccount(AccountCache.SAVING);
    ...
    public void testCloneCheckingAccountReturnsNewInstance() {
        AbstractAccount cloned = AccountCache.cloneAccount(AccountCache.CHECKING);
        AbstractAccount prototype = AccountCache.getAccount(AccountCache.CHECKING);
    ...
    public void testClonedAccountIsCorrectType() {
        AbstractAccount savingClone = AccountCache.cloneAccount(AccountCache.SAVING);
        AbstractAccount checkingClone = AccountCache.cloneAccount(AccountCache.CHECKING);
    ...
    public void testMultipleClonesAreIndependent() {
        AbstractAccount clone1 = AccountCache.cloneAccount(AccountCache.SAVING);
        AbstractAccount clone2 = AccountCache.cloneAccount(AccountCache.SAVING);
    ...
    public void testClearCacheRemovesAllPrototypes() {
        ...
        assertNull(AccountCache.getAccount(AccountCache.SAVING));
        assertNull(AccountCache.getAccount(AccountCache.CHECKING));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testCloneAfterClearThrowsException() {
        AccountCache.clearCache();
        AccountCache.cloneAccount(AccountCache.SAVING);
    }
}